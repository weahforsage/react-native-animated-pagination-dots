...
import {SlidingBorderProps} from "./types";
...
const SlidingBorder = ({
    ...
    const translateX = scrollX.interpolate({
        inputRange,
        outputRange: [-defaultProps.dotStyle + defaultProps.borderPadding, 0, defaultProps.dotStyle + defaultProps.borderPadding],
    });
                ...
                style={[
                    {
                        ...
                        borderRadius: (defaultProps.dotStyle + defaultProps.borderPadding) / 2,
                    },
